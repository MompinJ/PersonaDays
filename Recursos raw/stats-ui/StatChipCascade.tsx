...
//
// Cada chip rompe el patrón del anterior: zigzag de skew + escalonado
...
// Patrón de variación (la "cascada"). Se cicla con i % n.
const SKEWS = [-15, 12, -11, 15, -13]; // alterna DIRECCIÓN de inclinación
    ...
    <View style={styles.row}>
      {stats.map((key, i) => {
        ...
        return (
          ...
          >
            {/* contra-skew: el contenido vuelve a 0° y queda legible */}
...
const styles = StyleSheet.create({
  // alignItems flex-start para que el escalonado baje; paddingBottom cubre el escalón más alto
